...
\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=0.4\textwidth]{docs/latex/figures/heatmap_x_Robot_2.png}
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=0.4\textwidth]{docs/latex/figures/heatmap_y_Robot_2.png}
