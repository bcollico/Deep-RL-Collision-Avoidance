...
At the end of training we have these results for our two reward functions \todo[inline]{add numbers here}
\begin{center}
...
\begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{figures/collisions_0.png}
...
\end{figure}
\todo[inline]{expand qualitative analysis}
\section{Conclusion}
